...
<style>
 ...
 .wordSearchContainer h2 {
  text-transform: uppercase;
 }
 .wordSearchContainer .timer {
  position: absolute;
  top: 20px;
  right: 10px;
  font-size: 24px;
 ...
 .wordSearchContainer .finishGameOverlay .finishGameTable span {
  color: #fff;
  font-size: 56px;
  font-weight: 400;
 }
...
<script>
 ...
 $(document).ready(function() {
  ...
  var timerInterval = setInterval(function() {
   ...
   $('.wordSearchContainer .timer')[0].innerHTML = minutes + ':' + seconds;
  }, 1000);
